...
namespace SistemaFacturacion_API.Migrations
{
    ...
    [Migration("20240821225319_CreacionDeTablaServicio-TipoServicio")]
    partial class CreacionDeTablaServicioTipoServicio
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SistemaFacturacion_Model.Modelos.Servicio", b =>
                {
                    b.HasOne("SistemaFacturacion_Model.Modelos.Articulo", null)
                        .WithOne()
                        .HasForeignKey("SistemaFacturacion_Model.Modelos.Servicio", "Articulonro")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
